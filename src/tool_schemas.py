            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "schedule": {"type": "string", "enum": ["once", "daily", "weekly", "monthly", "cron"],
                                 "description": "Schedule frequency (for trigger_type=schedule). Use 'cron' for sub-daily intervals like every 5 minutes."},
                    "cron_expression": {"type": "string", "description": "Standard cron expression like '*/5 * * * *' (for schedule=cron). Only used when schedule is 'cron'."},
